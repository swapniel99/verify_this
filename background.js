(() => {
  ...
  // node_modules/.pnpm/@google+genai@1.50.1/node_modules/@google/genai/dist/web/index.mjs
...
${underline}`);
  ...
  var require_background = __commonJS({
    "src/background.js"() {
      init_web();
      var SYSTEM_INSTRUCTION = `You are a fact-checking assistant. When given a claim or piece of text, verify its accuracy using grounded search results. Provide:
